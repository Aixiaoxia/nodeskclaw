  ...
  >
    ...
    <g :transform="transformStr">
      ...
      >
        ...
        <polygon
          :points="hexPoints(0, 0)"
          :fill="agent.sse_connected ? ((agent.theme_color || statusColors[agent.status]) || '#a78bfa') + '22' : '#55556622'"
          :stroke="agent.sse_connected ? ((agent.theme_color || statusColors[agent.status]) || '#a78bfa') : '#555566'"
          stroke-width="2"
        ...
        <text
          ...
          dy="5"
          :fill="agent.sse_connected ? ((agent.theme_color || statusColors[agent.status]) || '#a78bfa') : '#6b7280'"
          font-size="7"
        >
